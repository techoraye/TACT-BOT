...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/techarye/techactivitybo/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/techarye/techactivitybo/releases/latest");
      }
    }
  }
  /**
