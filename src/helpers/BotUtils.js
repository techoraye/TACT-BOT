...
module.exports = class BotUtils {
  ...
  static async checkForUpdates() {
    const response = await getJson("https://api.github.com/repos/techarye/TACT-BOT/releases/latest");
    ...
    if (response.data) {
      if (
        ...
        warn("download: https://github.com/techarye/TACT-BOT/releases/latest");
      }
    }
  }
  /**
